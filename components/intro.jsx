...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Shoishob.</span> I'm a{" "}
        <span className="font-bold">frontend developer</span> with{" "}
        <span className="">years</span> of hands-on experience. I enjoy
        building <span className="italic">web applications and websites</span>. My focus is{" "}
        <span className="underline">Next.js</span> along with some other market demanding technologies.
      </motion.h1>
